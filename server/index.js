...
exports.default = app.use(_dev2.default).use(_bodyParser2.default.urlencoded({ extended: false })).use(_bodyParser2.default.json()).use(_express2.default.static(PATH_STATIC)).get('*', _ssr2.default).use(function (err, req, res) {
	console.error(err);
...
exports.default = _Root.env.NODE_ENV === 'development' ? router.use(__webpack_require__(35)).use(__webpack_require__(45)('dev')).use(function (req, res, next) {
